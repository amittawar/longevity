        ...
        <div className="relative bg-black min-h-screen">
            ...
            <main className="relative z-10 pt-32 pb-20 px-6 md:px-12 max-w-5xl mx-auto text-gray-300 font-light leading-relaxed">
                ...
                <section className="mb-12 space-y-6">
                    <h2 className="text-2xl text-white font-bold uppercase tracking-wide">1. Introduction</h2>
                    <p>
                ...
                <section className="mb-12 space-y-6">
                    <h2 className="text-2xl text-white font-bold uppercase tracking-wide">2. Medical Disclaimer</h2>
                ...
                <section className="mb-12 space-y-6">
                    <h2 className="text-2xl text-white font-bold uppercase tracking-wide">3. Use of the Service</h2>
                    <p>
                ...
                <section className="mb-12 space-y-6">
                    <h2 className="text-2xl text-white font-bold uppercase tracking-wide">4. User Accounts</h2>
                    <p>
                ...
                <section className="mb-12 space-y-6">
                    <h2 className="text-2xl text-white font-bold uppercase tracking-wide">5. Intellectual Property Rights</h2>
                    <p>
                ...
                <section className="mb-12 space-y-6">
                    <h2 className="text-2xl text-white font-bold uppercase tracking-wide">6. Termination</h2>
                    <p>
                ...
                <section className="mb-12 space-y-6">
                    <h2 className="text-2xl text-white font-bold uppercase tracking-wide">7. Limitation of Liability</h2>
                    <p>
                ...
                <section className="mb-12 space-y-6">
                    <h2 className="text-2xl text-white font-bold uppercase tracking-wide">8. Changes to Terms</h2>
                    <p>
                ...
                <section className="mb-12 space-y-6">
                    <h2 className="text-2xl text-white font-bold uppercase tracking-wide">9. Contact Us</h2>
                    <p>
